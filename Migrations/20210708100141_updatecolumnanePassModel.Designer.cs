...
namespace Flight_booking.Migrations
{
    ...
    [Migration("20210708100141_updatecolumnanePassModel")]
    partial class updatecolumnanePassModel
    {
            ...
            modelBuilder.Entity("Flight_booking.Models.FlightTripSchedule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TripId = 2,
                            AvailableDate = new DateTime(2021, 7, 8, 15, 31, 40, 446, DateTimeKind.Local).AddTicks(4475),
                            EndDateTime = new DateTime(2021, 7, 8, 17, 31, 40, 446, DateTimeKind.Local).AddTicks(5330),
                            FlightId = 2,
                            FromPlace = "Tirupathi",
                            SeatsAvailable = 100,
                            StartDateTime = new DateTime(2021, 7, 8, 15, 31, 40, 446, DateTimeKind.Local).AddTicks(4908),
                            ToPlace = "Hyderabad",
                            costPerSeat = 0
                        });
                });
            ...
            modelBuilder.Entity("Flight_booking.Models.Flightbookingsmodel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Userid = "1",
                            Username = "Jack",
                            bookeddate = new DateTime(2021, 7, 8, 15, 31, 40, 434, DateTimeKind.Local).AddTicks(3854),
                            numberofseats = 2,
                            onwarddate = new DateTime(2021, 7, 13, 15, 31, 40, 433, DateTimeKind.Local).AddTicks(932),
                            returndate = new DateTime(2021, 7, 15, 15, 31, 40, 433, DateTimeKind.Local).AddTicks(8497),
                            status = 1
                        },
                        new
                        {
                            ...
                            Userid = "2",
                            Username = "Jack2",
                            bookeddate = new DateTime(2021, 7, 8, 15, 31, 40, 434, DateTimeKind.Local).AddTicks(4588),
                            numberofseats = 1,
                            onwarddate = new DateTime(2021, 7, 13, 15, 31, 40, 434, DateTimeKind.Local).AddTicks(4575),
                            returndate = new DateTime(2021, 7, 15, 15, 31, 40, 434, DateTimeKind.Local).AddTicks(4581),
                            status = 1
                        });
                });
