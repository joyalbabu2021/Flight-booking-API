...
namespace Flight_booking.Migrations
{
    ...
    [Migration("20210626153519_changeFB_NOOFSEATS")]
    partial class changeFB_NOOFSEATS
    {
            ...
            modelBuilder.Entity("Flight_booking.Models.Flightbookingsmodel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Userid = "1",
                            Username = "Surya",
                            bookeddate = new DateTime(2021, 6, 26, 21, 5, 19, 90, DateTimeKind.Local).AddTicks(5422),
                            numberofseats = 2,
                            onwarddate = new DateTime(2021, 7, 1, 21, 5, 19, 89, DateTimeKind.Local).AddTicks(2638),
                            returndate = new DateTime(2021, 7, 3, 21, 5, 19, 90, DateTimeKind.Local).AddTicks(532),
                            status = 1
                        },
                        new
                        {
                            ...
                            Userid = "2",
                            Username = "Surya2",
                            bookeddate = new DateTime(2021, 6, 26, 21, 5, 19, 90, DateTimeKind.Local).AddTicks(6108),
                            numberofseats = 1,
                            onwarddate = new DateTime(2021, 7, 1, 21, 5, 19, 90, DateTimeKind.Local).AddTicks(6100),
                            returndate = new DateTime(2021, 7, 3, 21, 5, 19, 90, DateTimeKind.Local).AddTicks(6104),
                            status = 1
                        });
                });
