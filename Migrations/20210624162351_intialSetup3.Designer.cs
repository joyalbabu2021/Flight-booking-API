...
namespace Flight_booking.Migrations
{
    ...
    [Migration("20210624162351_intialSetup3")]
            ...
            modelBuilder.Entity("Flight_booking.Models.Flightbookingsmodel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Userid = "1",
                            Username = "Surya",
                            bookeddate = new DateTime(2021, 6, 24, 21, 53, 50, 960, DateTimeKind.Local).AddTicks(4339),
                            numberofseats = 3,
                            onwarddate = new DateTime(2021, 6, 29, 21, 53, 50, 958, DateTimeKind.Local).AddTicks(8747),
                            returndate = new DateTime(2021, 7, 1, 21, 53, 50, 959, DateTimeKind.Local).AddTicks(7201),
                            status = 1
                        });
                });
