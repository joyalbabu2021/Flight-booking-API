...
namespace Flight_booking.Migrations
{
    ...
    [Migration("20210627115648_changeFlightBookingData")]
    partial class changeFlightBookingData
    {
            ...
            modelBuilder.Entity("Flight_booking.Models.Flightbookingsmodel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Userid = "1",
                            Username = "Jack",
                            bookeddate = new DateTime(2021, 6, 27, 17, 26, 47, 550, DateTimeKind.Local).AddTicks(1999),
                            numberofseats = 2,
                            onwarddate = new DateTime(2021, 7, 2, 17, 26, 47, 548, DateTimeKind.Local).AddTicks(7560),
                            returndate = new DateTime(2021, 7, 4, 17, 26, 47, 549, DateTimeKind.Local).AddTicks(6620),
                            status = 1
                        },
                        new
                        {
                            ...
                            Userid = "2",
                            Username = "Jack2",
                            bookeddate = new DateTime(2021, 6, 27, 17, 26, 47, 550, DateTimeKind.Local).AddTicks(2999),
                            numberofseats = 1,
                            onwarddate = new DateTime(2021, 7, 2, 17, 26, 47, 550, DateTimeKind.Local).AddTicks(2986),
                            returndate = new DateTime(2021, 7, 4, 17, 26, 47, 550, DateTimeKind.Local).AddTicks(2994),
                            status = 1
                        });
                });
